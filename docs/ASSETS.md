...
As of this update, the repo contains the production-facing brand logo, two Open Graph images, a manifest icon set, pickup/delivery hero images, facility and service marketing photos, and hero/ad video assets. Do not document copied placeholder images as real Splash 'Em Out assets. Add rows here as real brand, location, service, and SEO assets are created or received.
...
| `/media/video/ad-c.mp4`                                            | `apps/web/public/media/video/ad-c.mp4`                                            | Ad video         | MP4, 16 MB                        | Campaign or promotional video asset. Use on ad landing pages or social-style embeds where the larger file size is acceptable.                              |
| `/media/video/hero-2-c.mp4`                                        | `apps/web/public/media/video/hero-2-c.mp4`                                        | Hero video       | MP4, 6.7 MB                       | Alternate hero motion asset. Use for homepage or service hero testing when static imagery is not enough and mobile performance is acceptable.              |
...
| `/images/marketing/driers.webp`                                    | `apps/web/public/images/marketing/driers.webp`                                    | Marketing image  | WebP, 2560x2560, 722 KB           | Square facility image of stacked dryers. Use for self-service laundry pages, facility proof sections, and dryer capacity callouts.                         |
| `/images/marketing/foltex-automated-folding-machine-joe-dan-3.jpg` | `apps/web/public/images/marketing/foltex-automated-folding-machine-joe-dan-3.jpg` | Marketing image  | JPEG, 2048x1536, 116 KB           | Automated folding equipment image for wash-and-fold, commercial laundry, process, and operations proof sections.                                           |
| `/images/marketing/machines.webp`                                  | `apps/web/public/images/marketing/machines.webp`                                  | Marketing image  | WebP, 2560x2560, 323 KB           | Bright facility image showing washers, folding tables, seating, and open floor space. Use for self-service, amenities, and location proof sections.        |
...
| `/images/marketing/membership-card.webp`                           | `apps/web/public/images/marketing/membership-card.webp`                           | Marketing image  | WebP, 2560x1707, 221 KB           | Reloadable laundry card closeup for payment, amenities, membership, and in-store convenience sections.                                                     |
