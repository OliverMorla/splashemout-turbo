...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const pillarRotRad = (initialUniforms.pillarRotation * Math.PI) / 180.0;
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uTopColor: { value: parseColor(initialUniforms.topColor) },
        uBottomColor: { value: parseColor(initialUniforms.bottomColor) },
        uIntensity: { value: initialUniforms.intensity },
        uInteractive: { value: initialUniforms.interactive },
        uGlowAmount: { value: initialUniforms.glowAmount },
        uPillarWidth: { value: initialUniforms.pillarWidth },
        uPillarHeight: { value: initialUniforms.pillarHeight },
        uNoiseIntensity: { value: initialUniforms.noiseIntensity },
        uPillarRotation: { value: initialUniforms.pillarRotation },
        uRotCos: { value: 1.0 },
        uRotSin: { value: 0.0 },
